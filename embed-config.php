  ...
  //  print_r($response);
   $data= json_decode($response['body'] ,true);
    ...
    if(isset($data['user']))
    {
         ...
         echo '1';                      //  Login Successfull Collect token
     }else{
         echo '0';                      //  Login failed
     }
    wp_die();
...
class franklySettingsPage
{
    ...
    {        
       ...
       /* add_settings_section(
            'setting_poll', // ID
            '<h2>Add Frankly Poll</h2>', // Title
            array( $this, 'add_frankly_poll' ), // Callback
            'frankly' // Page
        ); */
...
function add_frankly_poll()
{

    printf("</br>
            <h2>Frankly.me Poll</h2></br>");
...
?>
        ...
        <script type="text/javascript">
               ...
               function display(){
                    ...
                    if(type=='Ask')
                    {
                       document.getElementById('size').innerHTML='<option value="sm" > Small</option><option value="md"> Medium</option><option value="lg"> large</option>';
                       document.getElementById('code1').innerHTML= '[franklyAsk id="'+ wpid +'" type="'+size+'"]';
                    }

                    if(type=='HBadge')
                    {

                       document.getElementById('size').innerHTML='<option value="sm" > Small</option><option value="lg"> large</option>';
                       document.getElementById('code1').innerHTML= '[franklyHBadge id="'+ wpid +'" type="'+size+'"]';
                    }

                    if(type=='SBadge')
                    {
                       document.getElementById('size').innerHTML='<option value="sm" > Small</option><option value="md"> Medium</option><option value="lg"> large</option>';
                       document.getElementById('code1').innerHTML= '[franklySBadge id="'+ wpid +'" type="'+size+'"]';
                    }

                    if(type=='Answer')
                    {
                       document.getElementById('size').innerHTML='<option value="wd" > Widget</option>';
                       document.getElementById('code1').innerHTML= '[franklyAnswer id="'+ wpid +'"]';
                    }
                    if(type=='Contact')
                    {
                       document.getElementById('size').innerHTML='<option value="wd" > Widget</option>';
                       document.getElementById('code1').innerHTML= '[franklyContact id="'+ wpid +'" type="'+size+'"]';
                    }




                    /*if(type =='Ask'||ty=='Small'||ty=='AskLg')
        ...
        <div>
            ...
            <tr valign="top"><th>Widget Type</th>
                ...
                <select type="text" id="type1" onchange="display()">
                    ...
                    <option value='HBadge'> Horizontal Badge </option>
                    <option value='SBadge'> Sidereel Badge </option>
                    <option value='Answer'> Answer Widget </option>
            ...
            <tr valign="top"><th>Size </th>
                <td><select type="text" id="size" onchange="display()">
                     <!-- Have Look on Display Function -->
                     <option value="sm" selected onclick="(this).selected"> Small</option>
